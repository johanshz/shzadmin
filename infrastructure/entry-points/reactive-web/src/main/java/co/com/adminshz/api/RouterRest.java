...
public class RouterRest {
    ...
    public RouterFunction<ServerResponse> routerFunction(Handler handler) {
        return route(POST("/registerUser"), handler::registerUsers)
                ...
                .andRoute(GET("/getFactura"),handler::getFacturas)
                .andRoute(GET("/getFacturaId"),handler::getFacturaById)
                .andRoute(POST("/cargaArchivos").and(accept(MediaType.MULTIPART_FORM_DATA)),handler::handleCargaArchivo)
                .andRoute(POST("/saveContenidoApp"),handler::saveContenidoApp);
    }
}
